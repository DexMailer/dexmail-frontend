...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className="group group/sidebar peer hidden md:block text-sidebar-foreground"
        data-state={state}
...
>(({ className, ...props }, ref) => (
  <ul
    ...
    className={cn(
      "mx-3.5 flex min-w-0 translate-x-px flex-col gap-1 border-l border-sidebar-border py-1 pl-3",
      "group-data-[collapsible=icon]:hidden",
      className
    )}
    {...props}
